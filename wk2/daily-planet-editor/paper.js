...
var enemy_name=["Lex","Batman","Darkseid","Brainiac","General Zod","Doomsday"];
...
function whoWins(is_there_kryptonite, enemy_name)
{
    ...
    {
        return "Depending on how quickly Superman can get rid of the Kryptonite. "+ enemy_name +" could possibly win this one.";
    } 
}
